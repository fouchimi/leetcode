...
public class Problem726 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(problem726.countOfAtoms("K4(ON(SO3)2)2"));
        System.out.println(problem726.countOfAtoms("Mg(OH)2"));
        System.out.println(problem726.countOfAtoms("H2O"));
        System.out.println(problem726.countOfAtoms("H50"));
    }
}
